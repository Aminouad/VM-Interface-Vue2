<template>
  <div class="container" @submit.prevent="submitForm">
    <form>
      <div class="row">
        <h4>Nouvelle visite</h4>
        <div class="input-group input-group-icon">
          <input
            type="text"
            placeholder="Nom et prenom de visiteur"
            v-model.trim="visitorName"
          />
          <div class="input-icon"><i class="fa-solid fa-user-tie"></i></div>
        </div>
        <div class="input-group input-group-icon">
          <input type="text" placeholder="CIN" v-model.trim="cin" />
          <div class="input-icon"><i class="fa-solid fa-id-badge"></i></div>
        </div>
        <div class="input-group input-group-icon">
          <input
            type="datetime-local"
